...
\usepackage[utf8]{inputenc} % Ensure encoding is set to UTF-8 for compatibility
...
% Ensure figures and tables are properly numbered and that hyperlinks are colored black for printing and readability
\usepackage{color}
...
% Adjust margins to meet arXiv requirements
...
\begin{enumerate}
    ...
    \item E. Belyaev, "An Efficient Compressive Sensed Video Codec with Inter-Frame Decoding and Low-Complexity Intra-Frame Encoding," 2023.
    \item D. Huffman, "A Method for the Construction of Minimum-Redundancy Codes," Proceedings of the IRE, vol. 40, no. 9, pp. 1098–1101, 1952.
    \item J. Van Leeuwen, "On the construction of Huffman trees," in Proceedings of the 3rd Colloquium on Automata, Languages, and Programming (ICALP), pp. 382–410, 1976.
\end{enumerate}
